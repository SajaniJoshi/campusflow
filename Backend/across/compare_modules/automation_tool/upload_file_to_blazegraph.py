...
def upload_file_to_blazegraph(directory, file, isFile):
    if not isFile:
        ...
        #   req = urllib2.Request(url="http://10.57.14.199:9999/blazegraph/sparql", 
        #               data=datae, 
        #               headers={'Content-Type': 'application/xml'})
        #   urllib2.urlopen(req)
        #   result = requests.post("http://10.57.14.199:9999/blazegraph/sparql", files=data1)
        #   print(result)
        ...
        # print(data_xml)
        result = requests.post("http://10.57.14.199:9999/blazegraph/sparql", data=data_xml.encode('utf-8'), headers={'Content-Type': 'application/xml'})
