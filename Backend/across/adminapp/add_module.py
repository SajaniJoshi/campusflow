...
def add_module_in_blaze(request):
     try:
        ...
        print(data)
        server = sparql.SPARQLServer('http://10.57.14.199:9999/blazegraph/sparql', post_queries=True, post_directly=True)
      ...
      #   add_query_complete = add_module % (module_uri_g ,module_id_g, module_name_g , module_content_g, credit_points_g,uri_university, uri_course)
        ...
        result = requests.post("http://10.57.14.199:9999/blazegraph/sparql", data=payload)
        print(result)
